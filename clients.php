<?php
    ...
    $count=0;
    $list=[];
    $query = "SELECT idclient FROM client WHERE idclient IN (SELECT idclient FROM client WHERE  client.idclient=client.idclient)";
...
?>
   ...
   ?>
    ...
    <tbody>
       <?php while($Ligne= $pdostmt->fetch(PDO::FETCH_ASSOC)):
        ...
        <td><?php echo $Ligne["idclient"]; ?></td>
            ...
            <td>
               <a href="modifiClient.php?id=<?php echo $Ligne["idclient"]?>" class="btn btn-success">
    ...
    <!-- Script pour gérer le clic sur "Supprimer" -->
    <script>
        document.getElementById("confirmDelete").addEventListener("click", function () {
            alert("Client supprimé !");
            
            // Fermer la modale après action
