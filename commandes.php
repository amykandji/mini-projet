    ...
    <tbody>
       <?php while($Ligne= $pdostmt->fetch(PDO::FETCH_ASSOC)):
        ...
        <td><?php echo $Ligne["idcommande"]; ?></td>
          ...
          <td>
               <a href="modifiCommande.php?id=<?php echo $Ligne["idcommande"]?>" class="btn btn-success">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                ...
                <a href="delete.php?idcommande=<?php echo htmlspecialchars($Ligne["idcommande"]); ?>" class="btn btn-danger">Supprimer</a>
